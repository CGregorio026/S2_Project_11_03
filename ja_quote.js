...
*/
// calls the function in earlier

// Function to generate a random number between 0 and 9 (10 values).
function randomInt(lowest, size) {
    return Math.floor((Math.random() * 10));
};
// variable that records the value of the random number recorded earlier
var randomQ = randomInt();
// varable that references the quote tag
